...
class ReviewAdapter : ListAdapter<ReviewDomainModel, RecyclerView.ViewHolder>(ReviewDiffCallback()) {
    ...
    var onReviewClickListener: ((reviewDomainModel: ReviewDomainModel) -> Unit)? = null
